...
async sendStartMessage() {
    ...
    // ✅ If topic already mapped, just return it
    if (this.chatMappings.has(chatJid)) {
        return this.chatMappings.get(chatJid);
    }

    // ✅ Prevent concurrent topic creation for same JID
